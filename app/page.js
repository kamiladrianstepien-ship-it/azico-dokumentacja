    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0b0e14', fontFamily: "'DM Sans',system-ui,sans-serif", position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 380, padding: '0 24px' }}>
        ...
        <form onSubmit={(e) => {
          ...
          <label style={{ display: 'block', fontSize: 13, color: 'rgba(255,255,255,.4)', marginBottom: 8, fontWeight: 500 }}>Haslo dostepu</label>
          ...
          {err && <p style={{ color: '#ef4444', fontSize: 13, marginBottom: 12 }}>Nieprawidlowe haslo.</p>}
        ...
        <p style={{ textAlign: 'center', fontSize: 11, color: 'rgba(255,255,255,.1)', marginTop: 32 }}>System wewnetrzny Azico sp. z o.o.</p>
      </div>
    </div>
  );
